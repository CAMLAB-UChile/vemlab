function [K_global,f_global] = fem_sparse_assembly_linelast2d(domainMesh,config,matProps,body_force_fun_values)
...
%                       fem_body_force_linelast2d(verts,config,body_force_fun_values);   
