...
% Usage
% =====
% write_solution_txt_FEM2DQ4_linelast2d(mesh,displacements,stresses,...
%                                       strains,config)
%
% Input
% =====
...
function write_solution_txt_FEM2DQ4_linelast2d(mesh,displacements,stresses,strains,config)
  if ~strcmp(config.vemlab_method,'FEM2DQ4')
    throw_error('Error in write_solution_txt_quad4_linelast2d.m: vemlab_method')
  end
  fprintf('\n'); 
  ...
  for elem_i=1:numel
    ...
    fprintf(fid,'GP#   e_11      e_22      e_33     e_12      s_11       s_22       s_33      s_12      VM      e_1      e_2      e_3      s_1      s_2      s_3 \n');
    for gpoints=1:num_elem_gp
      gp=gp+1;
      fprintf(fid,'%7.4f %7.4f %7.4f %7.4f %7.4f %7.4f %7.4f %7.4f %7.4f %7.4f %7.4f %7.4f %7.4f %7.4f %7.4f\n', ...
              strains.e11(gp),strains.e22(gp),strains.e33(gp),...
              strains.e12(gp),stresses.s11(gp),stresses.s22(gp),...
              stresses.s33(gp),stresses.s12(gp),stresses.vm(gp),...
