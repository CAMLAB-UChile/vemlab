function write_solution_VTK_poisson2d(domainMesh,scalar_field,config)
  % plot to a VTK file   
  writeVTK(domainMesh.coords,domainMesh.connect,scalar_field,config);  
end
...
function writeVTK(coord,conec,field,config)
