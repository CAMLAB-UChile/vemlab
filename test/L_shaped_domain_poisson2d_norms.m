...
function L_shaped_domain_poisson2d_norms
  ...
  mesh_filename={'Lshape_poisson2d_104poly_elems_random_ssalinas.txt',...
...
%   mesh_filename={'Lshape_poisson2d_134poly_elems_semiuniform_ssalinas.txt',...
...
%                  'Lshape_poisson2d_76218poly_elems_voronoi_semiuniform_ssalinas.txt'};      
  ...
  for i=1:length(mesh_filename)      
    [h_max_1,L2rel_1,H1rel_1]=...
      L_shaped_domain_poisson2d(opsystem,vemlab_root_dir,mesh_filename{i},'VEM2D');
    xcm(1,i)=h_max_1;
    ycm(1,i)=H1rel_1;
    ycm1(1,i)=L2rel_1;      
  end
  
  textnote='random'; % 'random', 'semiuniform'
...
function H1plot(xcm,ycm,textnote)
  ...
  % Create plot 
  loglog(xc, yc1, '-d', 'Color', '[0.8500 0.3250 0.0980]', 'MarkerFaceColor', '[0.6500 0.1250 0.0680]', 'linewidth', 2.0, 'markersize', 6); 
  hold on;
...
function [h_max,L2rel,H1rel]=L_shaped_domain_poisson2d(opsystem,vemlab_root_dir,mesh_filename,vemlab_method)
