...
%   mesh_filename='big_wrench_143_q4_elems.txt';    
%   mesh_filename='big_wrench_444_t3_elems.txt';
%   mesh_filename='big_wrench_4000poly_elems.txt'; 
  ...
  Neumann_boundary_nodes=domainMesh.boundary_nodes.LeftHalfCircle;
  Neumann_boundary_dofs=domainMesh.boundary_dofs.LeftHalfCircle; 
  ...
  Dirichet_boundary_nodes=domainMesh.boundary_nodes.RightCircle;
  Dirichet_boundary_dofs=domainMesh.boundary_dofs.RightCircle; 
