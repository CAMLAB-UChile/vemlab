...
function cook_membrane_linelast2d
...
%   mesh_filename='cook_membrane_gunelvemesh_40x40.txt';   
  ...
  %% NEUMANN BOUNDARY NODES/DOFS/FUNCTIONS (right side of the membrane) 
  ...
  %% DIRICHLET BOUNDARY NODES/DOFS/FUNCTIONS (left side of the membrane) 
  % (see definition of functions at the bottom of this file)
...
function fy = fy_Neumann_fun(x,y,matProps)
  ...
  fy=6.25;    % is used as a force per length 
end
