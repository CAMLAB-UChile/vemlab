...
%-------------------------------------------------------------------------------
%
%                  Square Plate with Heat Source and Flux
%                           2D Poisson Problem
%
%-------------------------------------------------------------------------------
% References 
...
function square_plate_with_source_and_flux_poisson2d
  ...
  mesh_filename='square_plate_poisson2d_6000poly_elems.txt';  
  %mesh_filename='rectangular_plate_poisson2d_1000poly_elems.txt';
  ...
  Neumann_boundary_nodes=domainMesh.boundary_nodes.bottom;
  Neumann_boundary_dofs=domainMesh.boundary_dofs.bottom; 
  Neumann_fun_values.qn=@(x,y,matProps)qn_Neumann_fun(x,y,matProps);   
  ...
  % (see definition of functions at the bottom of this file)
  % The current problem has the left boundary with Dirichlet BCs. Therefore,
  % we set the "Dirichlet_boundary_nodes" variable to "mesh.boundary_nodes.left".
...
function qn = qn_Neumann_fun(x,y,matProps)
  ...
  qn=4.5;   % is used as a normal flux (in 2D, energy per unit length entering perpendicular to the Neumann boundary)
end
